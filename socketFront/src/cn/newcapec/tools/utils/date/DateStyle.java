...
public enum DateStyle {
	...
	YYYYMM("yyyyMM", false), YYYYMMDD("yyyyMMdd", false), YYYYMMDDHH(
			"yyyyMMddHH", false), YYYYMMDDHHMM("yyyyMMddHHmm", false), YYYYMMDDHHMMSS(
			"yyyyMMddHHmmss", false),

	MMDD("MMdd", false), MMDDHH("MMddHH", false), MMDDHHMM("MMddHHmm", false), MMDDHHMMSS(
			"MMddHHmmss", false),
