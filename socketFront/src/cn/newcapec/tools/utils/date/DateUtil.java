package cn.newcapec.tools.utils.date;
...
public abstract class DateUtil {
	 ...
	 * @return 日期
	 */
	public static String getDate(Date date, DateStyle ds) {
	...
	public static Date getOffDay(Date date, int offDay) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
		calendar.add(Calendar.DAY_OF_MONTH, offDay);
	...
	public static Date getOffSecond(Long time, int offSecond) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(time);
		calendar.add(Calendar.SECOND, offSecond);
		return calendar.getTime();

	}
	public static Date getCurryTime() {
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");//设置日期格式
		return StringToDate(df.format(new Date()));
	}
}
