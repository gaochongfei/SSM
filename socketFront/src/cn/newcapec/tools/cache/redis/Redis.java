package cn.newcapec.tools.cache.redis;

import cn.newcapec.tools.cache.Cache;
import cn.newcapec.tools.utils.Log;
import cn.newcapec.tools.utils.SerializeUtil;
import cn.newcapec.tools.utils.SysEnv;
...
public class Redis implements Cache {
	...
	private static List<RedisServerInfo> getServers() {
		String ser = SysEnv.getInstance().getString(SysEnv.CACHE_URL, "127.0.0.1:6379");
	...
	//释放jedis资源
	private static void returnResource(final ShardedJedis client) {
